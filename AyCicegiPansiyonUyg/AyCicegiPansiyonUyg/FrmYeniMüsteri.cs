...
namespace AyCicegiPansiyonUyg
{
    public partial class FrmYeniMüsteri : Form
    {
        ...
        private void DtpCikisTarihi_ValueChanged(object sender, EventArgs e)
        {
            ...
            DateTime BuyukTarıh = Convert.ToDateTime(DtpCikisTarihi.Text);


            TimeSpan Sonuc;
            Sonuc = BuyukTarıh - KucukTarih;
...
// Data Source = DESKTOP - BAAP0H2\SQLEXPRESS; Initial Catalog = AycicegiPansiyon; Integrated Security = True; Encrypt = False